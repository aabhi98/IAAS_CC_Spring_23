...
class AWSUtils:
    ...
    def send_message_to_response_queue(self, message: str) -> None:
        try:
            ...
            raise ValueError(f"Error sending message to Request Queue: {e}")
    ...
    def receive_message_from_request_queue(self):
        try:
            ...
            raise ValueError(f"Error receiving message from Request Queue: {e}")
    ...
    def delete_message_from_sqs(self, message: dict) -> None:
        try:
            ...
            raise ValueError(f"Error deleting message from SQS: {e}")
    ...
    def download_from_request_s3(self, object_key: str) -> bytes:
        try:
            ...
            raise ValueError(f"Error downloading object from Request S3: {e}")
    ...
    def upload_to_response_s3(self, object_key: str, content: bytes) -> None:
        try:
            ...
            raise ValueError(f"Error uploading object to Response S3: {e}")
